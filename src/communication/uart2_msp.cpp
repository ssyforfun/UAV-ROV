...
UART_HandleTypeDef *huart2Handle = &UartHandle;
void (*uart2_init)(void) = uart_default_init;
#define BAUD_RATE (115200) // 波特率, 常见有: 9600, 115200, 38400
#define USE_UART2 1
#define USART_INSTANCE USART2
#define USART_INSTANCE_CLOCK_ENABLE() __HAL_RCC_USART2_CLK_ENABLE()
...
#define USART_INSTANCE_TX_DMA_STREAM DMA1_Stream6
#define USART_INSTANCE_RX_DMA_STREAM DMA1_Stream5
#pragma endregion

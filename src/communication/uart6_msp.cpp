...
UART_HandleTypeDef *huart6Handle = &UartHandle;
void (*uart6_init)(void) = uart_default_init;
#define BAUD_RATE (115200) // 波特率, 常见有: 9600, 115200, 38400
#define USE_UART6 1
#define USART_INSTANCE USART6
#define USART_INSTANCE_CLOCK_ENABLE() __HAL_RCC_USART6_CLK_ENABLE()
#define USART_INSTANCE_DMA_CLOCK_ENABLE() __HAL_RCC_DMA2_CLK_ENABLE()
#define USART_INSTANCE_TX_DMA_CHANNEL DMA_CHANNEL_5 // refer to reference manual page 307 - 308
#define USART_INSTANCE_RX_DMA_CHANNEL DMA_CHANNEL_5
#define USART_INSTANCE_TX_DMA_STREAM DMA2_Stream6
#define USART_INSTANCE_RX_DMA_STREAM DMA2_Stream1
#pragma endregion

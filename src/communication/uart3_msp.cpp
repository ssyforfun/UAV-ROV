...
UART_HandleTypeDef *huart3Handle = &UartHandle;
void (*uart3_init)(void) = uart_default_init;
#define BAUD_RATE (115200) // 波特率, 常见有: 9600, 115200, 38400
#define USE_UART3 1
#define USART_INSTANCE USART3
#define USART_INSTANCE_CLOCK_ENABLE() __HAL_RCC_USART3_CLK_ENABLE()
...
#define USART_INSTANCE_TX_DMA_STREAM DMA1_Stream3
#define USART_INSTANCE_RX_DMA_STREAM DMA1_Stream1
#pragma endregion

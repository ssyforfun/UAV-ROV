...
UART_HandleTypeDef *huart4Handle = &UartHandle;
void (*uart4_init)(void) = uart_default_init;
#define BAUD_RATE (115200) // 波特率, 常见有: 9600, 115200, 38400
#define USE_UART4 1
#define USART_INSTANCE UART4
#define USART_INSTANCE_CLOCK_ENABLE() __HAL_RCC_UART4_CLK_ENABLE()
...
#define USART_INSTANCE_TX_DMA_STREAM DMA1_Stream4
#define USART_INSTANCE_RX_DMA_STREAM DMA1_Stream2
#pragma endregion
